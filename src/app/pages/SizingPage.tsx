      ...
      <div className="max-w-[900px] mx-auto px-6">
        ...
        >
          ...
          <div style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '14px', color: '#A0A0A0', lineHeight: 1.8 }}>
            ...
            <p className="mb-3">
              <strong style={{ color: '#F2F2F2' }}>Rule:</strong> If you're between sizes, go <span style={{ color: '#4A7BF7', fontWeight: 600 }}>UP one size for comfort</span>.
            </p>
            <p>
        ...
        >
          ...
          <a
            href="https://wa.me/919999999999?text=Hi!%20I%20need%20help%20finding%20my%20size%20for%20Cotton%20Aura%20compression%20tees."
            target="_blank"
