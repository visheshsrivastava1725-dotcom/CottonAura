      ...
      { path: 'bulk-orders', Component: () => (
        <div style={{ backgroundColor: '#0C0C0C', paddingTop: '140px', minHeight: '60vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <div className="text-center max-w-lg px-6">
            <p style={{ fontFamily: 'Bebas Neue, sans-serif', fontSize: '48px', color: '#4169E1', textTransform: 'uppercase' }}>BULK ORDERS</p>
            ...
            <a
              href="https://wa.me/919999999999?text=Hi!%20I%27m%20interested%20in%20bulk%20orders%20for%20Cooten Aura%20tees."
              target="_blank"
